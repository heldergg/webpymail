from django.template import TemplateSyntaxError, TemplateDoesNotExist, VariableDoesNotExist, Variable
...
class ExtendsNode(LoaderNode):
    # WARNING: this ceck must be disabled in order to allow us to load the alternate
...
class ConstantIncludeNode(LoaderNode):
    def __init__(self, template_name):
        self.template_name = template_name 

    def render(self, context):
        t = self.select_template(self.template_name, context )
        if t:
